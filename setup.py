"""setup.py file for the ``Maximum`` package.
"""
import fnmatch
import os
import sys
...
from maximum import __version__, __test_version__
...
setup(name='Maximum',
      version=VERSION,
      description='''Program that finds the maximum.''',
      ...
      keywords='maximum script',
      url='https://github.com/raul23/Maximum',
      author='R',
      license='GPLv3',
      ...
      entry_points={
        'console_scripts': ['runmax=maximum.runmax:main']
      },
      project_urls={  # Optional
          'Bug Reports': 'https://github.com/raul23/Maximum/issues',
          'Source': 'https://github.com/raul23/Maximum',
      },
      zip_safe=False)
